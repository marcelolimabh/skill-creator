...
const T: Record<Lang, Record<string, string>> = {
    en: {
        ...
        downloadSkillMd: "Download SKILL.md", downloadNpm: "Download npm package", downloadCli: "Download CLI", downloadMd: "Download MD",
    ...
    pt: {
        ...
        downloadSkillMd: "Baixar SKILL.md", downloadNpm: "Baixar pacote npm", downloadCli: "Baixar CLI", downloadMd: "Baixar MD",
...
const SKILL_MD = \`${skillYaml}\`;

const skillDir   = path.join(process.cwd(), '.claude', 'skills', 'project-skill');
fs.mkdirSync(skillDir, { recursive: true });

const skillFile  = path.join(skillDir, 'SKILL.md');
fs.writeFileSync(skillFile, SKILL_MD, 'utf8');
...
`;
    ...
    const getMdContent = () =>
`# SKILL.md\n\n---\n\nThis is the SKILL.md for your project's Claude skill, generated by [Skill Creator](https://github.com/marcelolimabh/skill-creator).\n\n**Location:** \`.claude/skills/project-skill/SKILL.md\`\n\n## How to use\n\n1. Copy the skill folder to your project:\n\n\`\`\`bash\nmkdir -p .claude/skills/project-skill\ncat > .claude/skills/project-skill/SKILL.md << 'EOF'\n${skillYaml}\nEOF\n\`\`\`\n\n2. Claude Code will automatically discover the skill.\n\n## Skill content\n\n\`\`\`markdown\n${skillYaml}\n\`\`\`\n\n## Versioning\n\nTrack changes with:\n\n\`\`\`bash\ngit diff .claude/skills/project-skill/SKILL.md\n\`\`\`\n`;
        ...
        return (
            <div style={{ padding: "1.5rem", maxWidth: 720, margin: "0 auto" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8, marginBottom: 28 }}>
                    <button onClick={() => download(skillYaml, "SKILL.md", "text/markdown")}
